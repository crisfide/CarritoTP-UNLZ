...
<form action="auth" method="post" style="max-width: 300px; margin: auto; font-family: Arial, sans-serif; border: 1px solid #ccc; padding: 20px 20px 40px; border-radius: 8px;">
